...
import * as sty from "./PlasmicFeatureSection.module.css"; // plasmic-import: NGLUJmz1On/css
      ...
      >
        ...
        >
          {(hasVariant(globalVariants, "screen", "tablet") ? true : true) ? (
            <div className={classNames(defaultcss.all, sty.column__m6Qeq)}>
              <p.Stack
                as={"div"}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Vector29Icon
                      className={classNames(defaultcss.all, sty.svg__tdEEs)}
                      role={"img"}
                    />
                  </p.Stack>
                </p.Stack>
          ...
          <div className={classNames(defaultcss.all, sty.column___9Zaeb)}>
            <div
